...
CREATE TABLE employee_address(
	...
	address_id INT,
	status_id INT,
	CONSTRAINT pk_empaddr PRIMARY KEY (employee_id, address_id),
	CONSTRAINT fk_ea_emp FOREIGN KEY (employee_id) REFERENCES employee (employee_id),
	CONSTRAINT fk_ea_addr FOREIGN KEY (address_id) REFERENCES address (address_id)
);
