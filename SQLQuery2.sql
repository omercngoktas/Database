...
WHILE(@counter < (@noOfOrders / @noOfEmp))
BEGIN
...
select * from cust_order co where co.employee_id is not NULL
update custome set custome.employee_id = NULL from cust_order custome
update custome set custome.employee_id = 1 from cust_order custome where custome.order_id > 15